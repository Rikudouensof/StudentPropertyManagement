...
namespace StudentPropertyManagement.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,PhoneNumber,Message,DateSent")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,PhoneNumber,Message,DateSent")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
